...
# add the message from (camera_detection) topic ---> check if ball found or not (bool)
import math
...
class RobotNavigator:
    def __init__(self):
        ...
        self.ball_detected_sub = rospy.Subscriber('/camera_detection', Bool, self.ball_detected_callback) #subscribe to camera results
    ...
    def check_zone(self):
        ...
        if self.robot_y > 1.1:  # The red line
            ...
            if not self.ball_detected:
                ...
                # add the logic to handle the ball detection (eg: kicking)
